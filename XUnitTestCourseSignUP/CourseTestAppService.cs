...
{
    public class CourseTestAppService : ICoursesAppService
    {
        private readonly IConfiguration _configuration;
        private Microsoft.Extensions.Logging.ILogger _LoggerFactory;
        CourseRepository _repository;

        #region  public CourseTestAppService (IConfiguration configuration, Microsoft.Extensions.Logging.ILogger logger_) 
        public CourseTestAppService(IConfiguration configuration, Microsoft.Extensions.Logging.ILogger logger_)
        {
